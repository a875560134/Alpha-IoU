...
def bbox_iouu(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False,EIoU=False,SIoU=True,a=3, eps=1e-7):
    ...
    if GIoU or DIoU or CIoU or EIoU or SIoU:
        ...
        if CIoU or DIoU or EIoU or SIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            c2 = (cw ** 2 + ch ** 2) ** a + eps  # convex diagonal
            ...
            if DIoU:
                ...
                return iou - (rho2 / c2 + torch.pow(v * alpha_ciou + eps, a))  # CIoU
            elif EIoU:
